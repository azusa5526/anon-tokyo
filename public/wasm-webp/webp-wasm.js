...
if (Module["locateFile"]) {
 wasmBinaryFile = "webp-wasm.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("webp-wasm.wasm", import.meta.url).href;
}
